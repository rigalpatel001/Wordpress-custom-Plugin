...
<?php
    global $wpdb;
    $table = new Custom_Distributor_List_Table();
    $table->prepare_items();
    $message = '';
...
?>
    <div class="wrap">
        ...
        <h2><?php _e('Distributors', 'aquascape') ?> 
         <a class="add-new-h2" href="<?php echo get_admin_url(get_current_blog_id(), 'admin.php?page=aquascape-disributorsmanage'); ?>"><?php _e('Add new', 'aquascape') ?></a>
         <a class="add-new-h2" href="<?php echo get_admin_url(get_current_blog_id(), 'tools.php?disributor_download'); ?>"><?php _e('Export', 'aquascape') ?></a>
        </h2>
         <ul class="subsubsub">
