...
<?php
    global $wpdb;
    $table = new  Custom_Locator_Leads_Table();
    $table->prepare_items();
    $message = '';
...
?>
    <div class="wrap">
        ...
        <h2><?php _e('Locator Leads', 'aqua_scape') ?> 
         <a class="add-new-h2" href="<?php echo get_admin_url(get_current_blog_id(), 'tools.php?locatorleads_download'); ?>"><?php _e('Export', 'aqua_scape') ?></a>
        </h2>
        <ul class="subsubsub">
